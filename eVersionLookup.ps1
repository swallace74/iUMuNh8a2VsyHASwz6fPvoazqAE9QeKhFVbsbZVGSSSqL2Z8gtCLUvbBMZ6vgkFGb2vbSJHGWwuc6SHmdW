$Script:eVersions = @(
    ...
    [pscustomobject]@{ VersionName = '2013'; LatestBuild = '15.00.1498'; Name = 'Cumulative Update 23a'; Url = 'https://docs.microsoft.com/en-us/exchange/new-features/build-numbers-and-release-dates?view=exchserver-2019#exchange-server-2013'; }
