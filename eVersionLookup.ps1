$Script:eVersions = @(
    ...
    [pscustomobject]@{ VersionName = '2013'; LatestBuild = '15.0.1497'; Name = 'Cumulative Update 23'; Url = 'https://docs.microsoft.com/en-us/exchange/new-features/build-numbers-and-release-dates?view=exchserver-2019#exchange-server-2013'; }
