...
$Script:eVersions = @(
    [pscustomobject]@{ VersionName = '2019'; LatestBuild = '15.02.0986.022'; Name = 'Exchange Server 2019 CU11 Security Update, March 8, 2022'; Url = 'https://docs.microsoft.com/en-us/exchange/new-features/build-numbers-and-release-dates?view=exchserver-2019#exchange-server-2019'; }
    [pscustomobject]@{ VersionName = '2016'; LatestBuild = '15.01.2375.024'; Name = 'Exchange Server 2016 CU22 Security Update, March 8, 2022'; Url = 'https://docs.microsoft.com/en-us/exchange/new-features/build-numbers-and-release-dates?view=exchserver-2019#exchange-server-2016'; }
    [pscustomobject]@{ VersionName = '2013'; LatestBuild = '15.00.1497.033'; Name = 'Exchange Server 2013 CU23 Security Update, March 8, 2022'; Url = 'https://docs.microsoft.com/en-us/exchange/new-features/build-numbers-and-release-dates?view=exchserver-2019#exchange-server-2013'; }
